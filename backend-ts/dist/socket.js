...
const Socket = (app) => {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on('sort', (filters) => __awaiter(void 0, void 0, void 0, function* () {
            filters.type = filters.type || CurrencyExchangeService_1.TYPE_ALL;
            filters.dateFrom = filters.dateFrom || '';
            filters.dateTo = filters.dateTo || '';
            filters.page = filters.page || 0;
            let records = yield CurrencyExchangeService_1.default.fetch(filters.type, filters.dateFrom, filters.dateTo, filters.page);
